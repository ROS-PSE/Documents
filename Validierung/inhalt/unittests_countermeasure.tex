...
\begin{unittest}{test\_interval\_wrong\_value}[pass]
    Testet ob bei invalider Eingabe für min\_reaction\_interval auf den standart Wert zurückgegriffen wird.
\end{unittest}
...
\begin{unittest}{test\_constraint\_timeout}[pass]
    Testet ob nach dem Ausführen einer Reaction solange zu nächsten Ausführung gewartet wird wie der Timeout ist.
\end{unittest}
...
\begin{unittest}{test\_add\_new\_than\_old}[pass]
    Testet ob eine zeitlich ältere Statistik keine zeitlich neueren Statistiken überschreibt. (Obwohl die ältere später hinzugefügt wird)
\end{unittest}
