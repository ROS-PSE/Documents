...
\begin{figure}[htbp]
    \begin{minipage}[t]{16cm}
        \vspace{0pt}
        \centering
        \includegraphics[scale=0.3]{./bilder/integrationstests/test_2_nodegraph.png} % TODO: neues bild
...
\end{figure}
    ...
    Im Fenster auf der rechten Seite wird der Reiter \textit{Graphs} ausgewählt. Darunter wird Range auf \texttt{60 Seconds} und Selected auf \texttt{delivered_msgs, frequency} gestellt.
