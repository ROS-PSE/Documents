...
\input{config/newComments.tex}
\input{config/layout.tex}					% Diese Datei enth�lt alle Layouteinstellungen
...
\include{content/classesdescription}
\include{content/sequences}
