...
\begin{itemize}
	...
	\item Wählt er einen Knoten aus, öffnet sich ein kleines Fenster mit den
	Knoteninformationen und reiht sich in die Übersicht der geöffneten Detailfenster ein.
\end{itemize}
...
\begin{itemize}
	...
	\item Monitor:  Herstellen einer Verbindung mit dem zu überwachenden Knoten.
					...
					Abgleichen von Ist- und Soll-Zustand um Abweichungen zu finden.
...
\begin{enumerate}
	...
	\item Fehlerhafter Knoten wird auf der GUI angezeigt
