...
\begin{itemize}
	\item Der Benutzer mochte entscheiden, welche Daten uberwacht werden sollen.
	...
	\item Die Metadaten werden uber Publisher-Subscriber an einen Monitor-Knoten geschickt.
\end{itemize}
...
\subsection*{Uberwachung eines Knoten}
\begin{itemize}
...
\subsubsection*{Story}
\begin{itemize}
	\item Der Benutzer definiert einen Soll-Zustand fur den Knoten und stellt Verbindung zum Monitor her.
		  Der zu uberwachende Knoten sendet seinen Ist-Zustand an den Monitoring-Knoten.
		  Der Monitor-Knoten gleicht die Ist-Zustand mit dem vorher definiertem Soll-Zustand ab.
		  Falls eine abweichung entdeckt wird , zeigt die rqt GUI den betroffenen Knoten an.
		  Der Benutzer kann sich fur eine Gegenmassnahme entscheiden.
\end{itemize}
\subsubsection*{Postcondition}
\begin{itemize}
	\item Fehlerzustand wurde erkannt
	\item Angemessene Gegenmasnahmen konnten getroffen werden.
\end{itemize}
...
\begin{enumerate}
	...
	\item Monitor empfangt Meta-Daten
	...
	\item Benutzer kann Gegenmasnahme treffen
\end{enumerate}
