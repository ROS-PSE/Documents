...
Um die Daten des Monitoring Knotens sinnvoll darstellen zu können soll eine graphische Oberfläche existieren, welche diese Daten übersichtlich darstellt. Hierbei gilt es, die bereits vorhandene rqt-Gui um weitere Funktionalität zu ergänzen, sei es in Form von neuen Widgets oder durch Modifikation bereits Existierender.
...
\subsection{ÜbersichtsWidget}
	...
	Die Informationen des InformationsTabs werden hier in Form von Graphen, d.h. im zeitlichen Verlauf dargestellt. Das betrachtete Intervall kann natürlich verändert werden.
	
	\includegraphics[width=\linewidth]{gui/uebersichtswidget_final_error.png}
	\caption{ÜbersichtsWidget - Tab Error}
	
	Im Fehlerfall ändert sich die Farbe der "Ampel", sodass der Nutzer unmissverständlich erkennt, dass ein Problem existiert, das für eine korrekte Funktionsweise behoben werden muss. Im Tab Error findet der Benutzer dann den Log der letzten Fehler um so schnell und einfach herauszufinden, wo das Problem liegt.
...
\subsection{Auswahl Widget}
	...
	Ähnlich wie das ÜbersichtsWidget ist auch dieses Widget in Tabs organisiert, wobei die Tabs Progress und Error ähnlich funktionieren wie beim Übersichtswidget, weshalb deren Funktionalität hier nicht erneut betrachtet werden soll.
