...
\begin{figure}[H]
	...
	\end{center}
	Im Bild zu sehen ist das Öffnen eines Widgets in der rqt GUI. Durch ihre sehr
	modulare Bauweise können beliebig viele Widget gestartet und gemeinsam, auf
...
\subsection{ÜbersichtsWidget}
	...
	korrekte Funktionsweise behoben werden muss. Im Error-Tab findet der Benutzer dann den Log der letzten Fehler, um so schnell und einfach herauszufinden, wo das Problem liegt.
	\end{figure}
