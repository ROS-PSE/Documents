...
\subsection{Optional}
\begin{description}
\fa Eigenständiger Knoten zur Überwachung der Hardware des Host-Systems
\fa Überwachung weiterer ROS Komponenten wie Services und Parameters
\fa Definition und Überwachung des Empfangs- und Sendeverhaltens eines Knotens
...
\fa Defaultwerte für Spezifikationsparameter
\fa Übergabe der Spezifikation bei Start des Überwachungsknotens
\fasec Weitergabe der Soll Spezifikation an den ROS Parameter Server bei Knotenstart
\fa Bestimmte Teilsysteme überwachen
\fasec Teilsysteme können sich überlappen
\fa Ein Überwachungsknoten für alle Teilsysteme
\end{description}

\section{API}
\subsection{Pflicht}
\begin{description}
\fa Die Metadaten werden durch Hinzufügen eines Funktionsaufrufes zu bestehenden Callbacks erfasst
